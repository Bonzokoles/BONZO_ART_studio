...
// ══════════════════════════════════════════════════════════════════════════════
// HTML GENERATOR: WORKFLOWS WINDOW (PART 4)
// ══════════════════════════════════════════════════════════════════════════════
...
<body>
  ...
  <header class="win-header">
    <div class="win-title">
      ...
      <span>NODE GRAPH PIPELINE</span>
    </div>
    <div class="win-controls">
      <button type="button" class="ctrl-btn" title="Minimize">[_]</button>
      <button type="button" class="ctrl-btn" title="Maximize">[&#9633;]</button>
  ...
  <div class="workspace-layout">
    ...
    <aside class="nodes-sidebar">
      ...
      <div class="node-group">
        ...
        <div class="node-item">
          ...
          <span class="node-type-tag">TXT</span>
        </div>
        <div class="node-item">
          <span>Image Loader</span>
          <span class="node-type-tag">IMG</span>
        </div>
        <div class="node-item">
          <span>Mask Input</span>
          <span class="node-type-tag">MSK</span>
        </div>
      </div>
      ...
      <div class="node-group">
        ...
        <div class="node-item">
          <span>Gen (Image)</span>
          <span class="node-type-tag">DIFF</span>
        </div>
        <div class="node-item">
          <span>Edit (Inpaint)</span>
          <span class="node-type-tag">INP</span>
        </div>
        <div class="node-item">
          <span>Upscale 4x</span>
          <span class="node-type-tag">UPS</span>
        </div>
        <div class="node-item">
          <span>Video Gen</span>
          <span class="node-type-tag">VEO</span>
        </div>
      </div>
      ...
      <div class="node-group">
        ...
        <div class="node-item">
          ...
          <span class="node-type-tag">OUT</span>
        </div>
        <div class="node-item">
          <span>Export ZIP</span>
          <span class="node-type-tag">ZIP</span>
        </div>
      </div>
    </aside>
    ...
    <main class="canvas-area">
      <!-- Mock Diagram in Background -->
      <div class="mock-flow">
        <div class="mock-node">
          <div class="mock-node-header">PROMPT NODE</div>
          <div class="mock-node-body">
            <div>&bull; text_out &rarr;</div>
          </div>
        </div>
        <div style="font-family:monospace; color:#374151;">&mdash;&mdash;&gt;</div>
        <div class="mock-node">
          <div class="mock-node-header">FLUX SAMPLER</div>
          <div class="mock-node-body">
            <div>&bull; prompt_in</div>
            <div>&bull; latent_out &rarr;</div>
          </div>
        </div>
        <div style="font-family:monospace; color:#374151;">&mdash;&mdash;&gt;</div>
        <div class="mock-node">
          <div class="mock-node-header">IMAGE VIEWER</div>
          <div class="mock-node-body">
            <div>&bull; image_in</div>
          </div>
        </div>
      </div>

      <!-- Center Overlay Badge -->
      <div class="canvas-center-badge">
        <div class="canvas-title">WORKFLOW CANVAS</div>
        <div class="canvas-sub">(LiteGraph.js will render here)</div>
        <div class="canvas-instruction">
          Drop nodes from palette &rarr; connect edges &rarr; run pipeline
        </div>
        <div class="canvas-status-pill">
          STATUS: COMING SOON // LiteGraph.js integration pending
        </div>
      </div>
    </main>
  </div>
  ...
  <footer class="ops-bar">
    <div class="ops-status">
      <span>[GRAPH: IDLE]</span>
      <span style="color:#1f2937;">|</span>
      <span>0 NODES LOADED</span>
    </div>
    <div class="ops-actions">
      <button type="button" class="btn-ops">[CLEAR]</button>
      <button type="button" class="btn-ops">[LOAD TEMPLATE]</button>
      <button type="button" class="btn-ops btn-run" disabled>[RUN WORKFLOW]</button>
    </div>
  </footer>
